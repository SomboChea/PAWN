...
namespace SA_PAWN_Company
{
    ...
    {
        private Control[] requirement { get; set; }
        ...
        private object clear(Control mains)
        {
            ...
            try
            {
                txtprice.Text = double.Parse(Connect.ExecuteScalar("Select Price from viewInventory2 Where SID=" + cbinventoryname.SelectedValue) + "").ToString("#,##0.00");
            }
            catch (Exception)
            {
                txtprice.Text = 0 + "";
        ...
        private void cbinventoryname_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string imgname = Connect.ExecuteScalar("Select Photo from viewInventory2 Where SID=" + cbinventoryname.SelectedValue) + "";
        ...
        {
            cbinventoryname.DataSource = null;
            Helper.FillCombobox(cbinventoryname, "Stuff", "SID", "Select * from viewInventory2 Where STID=" + cbinventype.SelectedValue);
        }

        private void btnAdd_Click(object sender, EventArgs e)
        {
            if (!Helper.CheckRequirement(bunifuCards1, requirement))
            {
                return;
            }
        ...
        private void btnSale_Click(object sender, EventArgs e)
        {
            ...
            tryagain:
                ...
                {
                    MessageBox.Show("No Item !", "Sale Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            };
        }
    }
